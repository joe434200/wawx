...
if (empty($_REQUEST['act']) || $_REQUEST['act'] == 'ini')//列表
{
	...
	$list = $admin->getCommentOfGoodsByGoodsID($goodid,$currpage,PAGE_NUMBER,$_SESSION['query']);//修改为自己的分页查询函数
	$data = $admin->getShopGoodsInfo($goodid);
	...
	$smarty->display("backstage/goodscomment_list.htm");
}
else if ($_REQUEST['act'] == 'del')
{
	...
	echo "location='shopadmin_goodscomment.php?id=$sid&f=$from';";
	echo "</script>";
}
