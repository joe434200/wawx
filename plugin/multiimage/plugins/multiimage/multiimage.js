...
//window.handlerpath = "";
window.par = "";
//handlerpath = document.getElementById("handler_path").value;
//handlerpath = "php/upload_json.php";
//添加参数
function addpars(name,hidid)
{
	
	var value = document.getElementById(hidid).value;
	par = name+"="+value;
	//alert(par);
}
...
KindEditor.plugin('multiimage', function(K) {
	var self = this, name = 'multiimage',
		...
		uploadJson = K.undef(self.uploadJson, self.basePath+"../../"+document.getElementById("handler_path").value),
		imgPath = self.pluginsPath + 'multiimage/images/',
		imageSizeLimit = K.undef(self.imageSizeLimit, '10MB'),
		imageFileTypes = K.undef(self.imageFileTypes, '*.jpg;*.gif;*.png;*.JPG;*.BMP;*.GIF'),
