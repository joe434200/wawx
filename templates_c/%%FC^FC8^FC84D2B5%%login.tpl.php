<?php /* Smarty version 2.6.18, created on 2013-06-08 21:30:22
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td colspan="2"><input type="text" name="email" id="email"
			class="txt_zhuce" value="<?php echo $this->_tpl_vars['email']; ?>
"/>
	...
	<tr>
		...
		<td width="59%"><input type="password" name="password"
			id="password" class="txt_zhuce" value="<?php echo $this->_tpl_vars['password']; ?>
"/></td>
		<td width="23%" class="a0392"><a href="reg_reback.php">找回密码？</a></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td height="40" colspan="2" valign="bottom"><input name="rememberstatus" id="rememberstatus" type="checkbox" <?php if ($this->_tpl_vars['rememberstatus'] == '1'): ?>checked="checked"<?php endif; ?>  />
		记住用户&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
	<tr>
		<td>&nbsp;</td>
