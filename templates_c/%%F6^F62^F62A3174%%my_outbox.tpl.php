<?php /* Smarty version 2.6.18, created on 2013-06-08 09:36:58
         compiled from user/my_outbox.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'user/my_outbox.tpl', 46, false),)), $this); ?>
...
" /></td>
    ...
    <td width="12%" align="center"><input name="Input" type="button"  value="删除"  onclick="javascript:AjaxDelBox(1,'<?php echo $this->_tpl_vars['item']['ID']; ?>
')"/></td>
  </tr>
  <tr valign="top" class="pic">
  <td>&nbsp;</td>
  ...
  <?php endif; ?>
   ...
   <?php if (count($this->_tpl_vars['info']['info']) != 0): ?>
		...
		<?php else: ?>
		    ...
		    <?php else: ?>
		    <a  href="javascript:void(0)" onclick="javascript:AjaxGetBox('1','<?php echo $this->_tpl_vars['info']['base']['page']-1; ?>
')">上一页</a>
		    <?php endif; ?>
...
?>
		    	...
		    	<?php else: ?>
		    	&nbsp;<a href="javascript:void(0)" onclick="javascript:AjaxGetBox('1','<?php echo $this->_sections['loop']['index']+1; ?>
