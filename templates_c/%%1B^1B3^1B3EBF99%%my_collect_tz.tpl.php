<?php /* Smarty version 2.6.18, created on 2013-06-03 18:49:31
         compiled from user/my_collect_tz.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'user/my_collect_tz.tpl', 54, false),)), $this); ?>
...
?>
  <tr>
    <td width="7%" align="center"><input type="checkbox" name="GoodSel" value="<?php echo $this->_tpl_vars['item']['ID']; ?>
" /></td>
    <td width="15%" align="center">校吧帖子</td>
    <td width="56%" align="center"><a href="<?php echo $this->_tpl_vars['item']['collecturl']; ?>
"><?php echo $this->_tpl_vars['item']['collectname']; ?>
</a></td>
  ...
  <?php endforeach; endif; unset($_from); ?>
   ...
   <?php if (count($this->_tpl_vars['data']['info']) != 0): ?>
		...
		<?php else: ?>
		    ...
		    <?php else: ?>
		    <a  href="javascript:void(0)" onclick="javascript:userTZCollect('<?php echo $this->_tpl_vars['data']['base']['page']-1; ?>
')">上一页</a>
		    <?php endif; ?>
...
?>
		    	...
		    	<?php else: ?>
		    	&nbsp;<a href="javascript:void(0)" onclick="javascript:userTZCollect('$smarty.section.loop.index+1}')"><?php echo $this->_sections['loop']['index']+1; ?>
</a>
		    	<?php endif; ?>
		    <?php endfor; endif; ?>
