...
<div class="q_toper">
	   ...
	   <li class="rr"><a href="#">亲，欢迎来到吾校！</a> </li>
	   		{if $base.nickname neq ""}
	   		<li class="rr"><a href="javascript:void(0)" onclick="javascript:window.location='self_zone.php'">{$base.nickname}</a></li>
	   		{else}
	   		<li class="rr"><a href="javascript:void(0)" onclick="javascript:window.location='self_zone.php'">{$base.email}</a></li>
	   		{/if}
	   {else}
...
<div class="wb_head">
<h3 style="font-family:KaiTi">{if $wbinfo.nickname eq ""}{$wbinfo.email}{else}{$wbinfo.nickname}{/if}的个人空间</h3>
<p></p>
</div>
</div>
...
<div class="wb_bd_l_p">
  <div class="pic"><a href="javascript:void(0)" onclick="window.location='wb_index.php'"><img src="{$wbinfo.photo}" /></a></div>
  <div class="name blue_s"><a href="javascript:void(0)">{if $wbinfo.nickname eq ""}{$wbinfo.email}{else}{$wbinfo.nickname}{/if}</a></div>
</div>
...
<div class="wb_bt blue_s">空间访问权限</div>


<div class="space_personal_ny clearfix" style="height:650px;">
<div align="center"><img src="./templates/images/schoolbar/search_3.gif"/></div>
<br/>
<br/>
<div align="center"><p style="font-size:15pt;">{$msg}</p></div>
<div align="center"><a href="javascript:void(0)" onclick="parent.history.back();" style="font-size:15pt;background:url(./templates/images/schoolbar/bj5.gif)">返回</a></div>
