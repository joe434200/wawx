...
// Tree object
function dTree(objName,iconPath,mulorsing) {
    this.config = {
        target                  : null,
        folderLinks         : true,
        useSelection        : true,
        ...
        inOrder                 : false,
        check:mulorsing     //added by wallimn 2009-02-05, to control whether checkbox is showed
    };
    //modified by wallimn 2009-02-05, in order to make client can modify path of icons;
    if(!iconPath) iconPath='./templates/images/tree/';//set the default value, be compatible with dtree
