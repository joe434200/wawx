...
showPages.prototype.createHtml = function(mode){ //生成html代码  
    ...
    //  
           ...
           /* strHtml += '<span class="count">共' + this.pageCount + '页 &nbsp当前第 <strong>' + this.page + '</strong> 页&nbsp;</span>';  */
            ...
            if (prevPage < 1) {  
                strHtml += '<span title="首页" class="disabled prev_page"><<</span>&nbsp;';  
                strHtml += '<span title="上一页" class="disabled prev_page"><</span>&nbsp;';  
            } else {  
                strHtml += '<span title="首页"><a href="javascript:' + this.name + '.toPage(1);"><<</a></span>&nbsp;';  
                strHtml += '<span title="上一页" class="prev_page" rel="prev start"><a href="javascript:' + this.name + '.toPage(' + prevPage + ');"><</a></span>&nbsp;';  
            }  
            ...
            if (nextPage > this.pageCount) {  
                strHtml += '&nbsp;<span title="下一页" class="disabled next_page">></span>';  
                strHtml += '&nbsp;<span title="尾页" class="disabled next_page">>></span>';  
            } else {  
                strHtml += '&nbsp;<span title="下一页" class="next_page" rel="next"><a href="javascript:' + this.name + '.toPage(' + nextPage + ');">></a></span>';  
                strHtml += '&nbsp;<span title="尾页" class="next_page" rel="next"><a href="javascript:' + this.name + '.toPage(' + this.pageCount + ');">>></a></span>';  
            }  
            strHtml += '</span>';  
			strHtml += '</div>';
...
showPages.prototype.createUrl = function (page) { //生成页面跳转url  
    ...
    arr = this.name.split("_");//规则：arg_0,arg_1,arg_2
    if (arr.length > 1)
    {
    	 args += '&key=' + arr[1];  
    }
