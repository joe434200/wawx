...
<table width="100%" border="0" cellspacing="0" cellpadding="0"
	...
	<tr>
		...
		<td><input type="password" name="user[password]" id="pwd"
			class="my_txt_350" onblur="check_vali_pwd(this)" value="{$temp.password}" onfocus="javascript:setPwdEnterError(this,false,'','');"/><span id="tips_pwd_ck"></span></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
	...
	<tr>
		...
		<td><input type="password" name="user[repassword]" id="repwd"
			class="my_txt_350" onblur="javascript:check_vali_repwd(this)" value="{$temp.password}" onfocus="javascript:setPwdEnterError(this,false,'','');"/><span id="tips_repwd_ck"></span></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td align="right">&nbsp;</td>
