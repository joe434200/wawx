...
<div class="backbj clearfix">
   ...
   <div class="box">
     <div class="case clearfix">
	   <div class="q_bt">寻觅你的兴趣圈</div>
<form action="grp_home.php?module=interest" method="post" id ="frm2" name="frm2">
	   <ul class="q_type  clearfix">
 <table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top"><li>圈子类型：</li></td>
    <td valign="top"><dl class="a666_b">
		  <dd><a href="#" onclick="selectGrpType('0');">全部</a></dd>
		  {foreach from=$type item=item key=key}
		  <dd><a href="#" onclick="selectGrpType('{$item.id}');">{$item.name}</a><span>({$item.groupnum})</span></dd>
		  {/foreach}
	   </dl>
	 <input type="text" id="secondID" name="secondID" value="{$selectMsg.type.ID}" style="display:none">
	 </td> 
  </tr>
 <tr>
  ...
  {else}
  	<td valign="top"> <li>搜索标签：</li></td>
  	 <td valign="top"><dl class="a666_b">
  	 <dd><a href="grp_home.php?module=interest">清空</a></dd>
 ...
 {/if}
   ...
   <div class="AreaL">
	   ...
	   <div class="case clearfix">
	   <div class="q_bt q_bj1"><span class=" aff6600"><a href="#" onclick="selectGrpMethod('0')">↑按时间</a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="selectGrpMethod('1')">↑按热度</a></span><em class=" aff6600">全部</em>&nbsp;&nbsp;&nbsp;共{$typenumber}条</div>
