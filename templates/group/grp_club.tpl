...
<div class="backbj clearfix">
   ...
   <div class="box">
     <div class="case clearfix">
	   ...
	   <form action="grp_home.php?module=club" method="post" id ="frm2" name="frm2">
    ...
    <td valign="top">
	  <dl class="a666_b">
		  <dd><a href="grp_home.php?module=club">不限</a></dd>
		     <dt> 
 ...
 {/if}
   ...
   <div class="AreaR">
	   ...
	   <!--创建圈子-->
	   <div class="case clearfix">
	        <div class="q_search_q"><a href="grp_home.php?module=create">创建社团圈子</a></div>
	   </div>
	   <!--创建圈子-->
