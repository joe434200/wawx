...
<div class="backbj clearfix">
   ...
   <div class="box">
     <div class="case clearfix">
	   <div class="q_bt">关键词：{$keyword}</div>
   ...
   <div class="AreaL">
	   ...
	   <div class="case clearfix">
	   <div class="q_bt q_bj1"><span class=" aff6600"><a href="grp_home.php?module=select">↑按时间</a>&nbsp;&nbsp;&nbsp;<a href="grp_home.php?module=select&method=member">↑按热度</a></span><em class=" aff6600">全部</em>&nbsp;&nbsp;&nbsp;共{$typenumber}条</div>
   ...
   <div class="AreaR">
	   ...
	   <!--圈子达人-->
	   <div class="case clearfix">
	        <div class="q_bt_r"><span class="a0693e3"><a href="#">换一组</a></span>社团达人</div>
			
		 <ul class="part4 clearfix a666">
	    {foreach from=$super.super item=item key=key}
		 <li>
	      <img src="./templates/images/schoolbar/6.jpg" />
